...
const RAIN: PaletteEntry[] = [
  {
    color: { lightness: 0.973, chroma: 0.007, hue: 268.548, alpha: 1 },
    hex: "#f4f6fb",
  },
  {
    color: { lightness: 0.9429, chroma: 0.0141, hue: 268.49, alpha: 1 },
    hex: "#e8ecf6",
  },
  {
    color: { lightness: 0.8773, chroma: 0.0284, hue: 263.421, alpha: 1 },
    hex: "#cdd7ea",
  },
  {
    color: { lightness: 0.7677, chroma: 0.0559, hue: 263.156, alpha: 1 },
    hex: "#a1b4d8",
  },
  {
    color: { lightness: 0.6412, chroma: 0.0875, hue: 260.849, alpha: 1 },
    hex: "#6e8dc2",
  },
  {
    color: { lightness: 0.5405, chroma: 0.1038, hue: 261.415, alpha: 1 },
    hex: "#4c6eab",
  },
  {
    color: { lightness: 0.4959, chroma: 0.1094, hue: 262.94, alpha: 1 },
    hex: "#4060a0",
  },
  {
    color: { lightness: 0.397, chroma: 0.086, hue: 264.255, alpha: 1 },
    hex: "#2f4575",
  },
  {
    color: { lightness: 0.3602, chroma: 0.0702, hue: 263.991, alpha: 1 },
    hex: "#2a3c62",
  },
  {
    color: { lightness: 0.3316, chroma: 0.0545, hue: 265.154, alpha: 1 },
    hex: "#283552",
  },
  {
    color: { lightness: 0.2552, chroma: 0.0415, hue: 267.536, alpha: 1 },
    hex: "#1a2237",
  },
]
...
const BRICK: PaletteEntry[] = [
  {
    color: { lightness: 0.9705, chroma: 0.0129, hue: 17.38, alpha: 1 },
    hex: "#fef2f2",
  },
  {
    color: { lightness: 0.937, chroma: 0.0286, hue: 17.674, alpha: 1 },
    hex: "#fde3e3",
  },
  {
    color: { lightness: 0.8871, chroma: 0.0545, hue: 16.827, alpha: 1 },
    hex: "#fccccd",
  },
  {
    color: { lightness: 0.8105, chroma: 0.096, hue: 18.566, alpha: 1 },
    hex: "#f9a8a9",
  },
  {
    color: { lightness: 0.7121, chroma: 0.154, hue: 20.768, alpha: 1 },
    hex: "#f37678",
  },
  {
    color: { lightness: 0.634, chroma: 0.1956, hue: 24.01, alpha: 1 },
    hex: "#e94a4c",
  },
  {
    color: { lightness: 0.571, chroma: 0.2052, hue: 26.231, alpha: 1 },
    hex: "#d62c2e",
  },
  {
    color: { lightness: 0.5063, chroma: 0.1842, hue: 26.381, alpha: 1 },
    hex: "#b72224",
  },
  {
    color: { lightness: 0.4399, chroma: 0.1537, hue: 25.537, alpha: 1 },
    hex: "#951f21",
  },
  {
    color: { lightness: 0.3939, chroma: 0.1264, hue: 24.589, alpha: 1 },
    hex: "#7c2021",
  },
  {
    color: { lightness: 0.2559, chroma: 0.0837, hue: 24.484, alpha: 1 },
    hex: "#430c0d",
  },
]
