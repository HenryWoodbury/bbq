...
const HDR =
  "IDPLAYER,PLAYERNAME,BIRTHDATE,FIRSTNAME,LASTNAME,POS,TEAM,LG,ACTIVE,MLBID,IDFANGRAPHS,CBSID,ESPNID,YAHOOID,FANTRAXID,RETROID,NFBCID,BREFID,BATS,THROWS"
const VALID_CSV = [
  HDR,
