...
const NICKNAMES = [
  "Mr. Smile", "The Penguin", "Scrabble", "The Password", "The Human Rain Delay",
  "Joey Bats", "Oil Can", "The Big Hurt", "The Big Unit", "Kung Fu Panda",
  "Turkey", "The Say Hey Kid", "The Splendid Splinter", "Mr. October", "The Wizard",
  "Big Papi", "PTBNL", "Pickles", "Boomstick", "Sweet Lettuce", "Porterhouse",
  "Tokki 1", "Tokki 2", "Three Finger", "Tungsten Arm", "Wagon Tongue",
  "Junebug", "Big Salt", "El Pulpo", "Matatán", "Polar Bear", "Mr. Jello",
  "Mr. Duck", "Saturn Nuts", "Big Train", "Terremoto", "The Earl of Snohomish",
  "Baggy", "Barnicles", "Pooch", "El Gallo", "Bunions", "Cool Papa", "Tito",
  "El Koja", "El Pikante", "Bananas", "Fat Elvis", "Birdman", "Preacher",
  "Gray Flamingo", "Duke", "Bear", "Professor", "Deacon", "Boardwalk",
  "Downtown", "Diesel", "Smoky",
] as const
...
export type PlayerFormGridProps = {
  ...
  onChange: <K extends keyof OverrideFields>(key: K, val: OverrideFields[K]) => void
  undo?: UndoControls
